...
func (r *AnswerStorage) Insert(ans *answer.Answer) error {
...
func (r *AnswerStorage) Get(id int) (*answer.Answer, error) {
...
func (r *AnswerStorage) GetAll() (answers []answer.Answer, err error) {
...
func (r *AnswerStorage) Update(ans *answer.Answer) error {
